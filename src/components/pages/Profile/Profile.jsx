...
/**
 * Renders the user's profile page with banner, avatar, bookings,
 * and an option to update profile details.
 *
...
export default function ProfilePage() {
  ...
  /**
   * Removes a cancelled booking from state and reloads.
   * @param {number|string} bookingId - ID of the booking to cancel.
   */
