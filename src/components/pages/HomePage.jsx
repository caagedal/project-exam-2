  ...
  return (
    <div className="min-h-screen text-neutral-dark mx-auto flex flex-col p-4">
      ...
      <div className="relative">
        ...
        {/* Search Bar */}
        <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-8 sm:-bottom-12 w-full max-w-6xl">
          <div className="mx-4 bg-blue-main rounded-lg shadow-xl py-6 sm:py-8 px-6 sm:px-12">
              ...
              <form onSubmit={handleSearch} className="flex items-center w-full">
                <div className="flex-1 flex items-center px-2 sm:px-4">
                  ...
                  <input
                    ...
                    className="w-full px-2 sm:px-4 py-2 focus:outline-none"
                    value={searchTerm}
                ...
                {isSearchPerformed ? (
                  ...
                  <button
                    type="submit"
                    className="bg-blue-600 text-neutral-dark px-4 sm:px-8 py-2 sm:py-3 rounded-full hover:bg-blue-700 transition-colors"
                  >
                    Search
                  </button>
                )}
